...
public static class DebugActions
{
    ...
    // [DebugAction("Map", "Grow plants to maturity in area (rect)", false, false, false, false, 0, false, actionType = DebugActionType.Action, allowedGameStates = AllowedGameStates.PlayingOnMap,
    //     displayPriority = 100)]
    ...
    //                 return;
    //             int num = (int) ((1.0 - plant.Growth) * plant.def.plant.growDays);
    //             plant.Age += num;
    //             plant.Growth = 1f;
    ...
    [DebugAction("Map", "Replant area (rect)", false, false, false, false, 0, false, actionType = DebugActionType.Action, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 100)]
    private static void ReplantArea()
    {
        DebugToolsGeneral.GenericRectTool("Replant", rect =>
        {
            float currentPlantDensity = Find.CurrentMap.wildPlantSpawner.CurrentPlantDensity;
            float numDesiredPlants = Find.CurrentMap.wildPlantSpawner.CurrentWholeMapNumDesiredPlants;
    ...
    [DebugAction("Map", "Grow plants of type", false, false, false, false, 0, false, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 100)]
    ...
    [DebugAction("Map", "Clear items in area (rect)", false, false, false, false, 0, false, actionType = DebugActionType.Action, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 100)]
    ...
    [DebugAction("Map", "Clear plants in area (rect)", false, false, false, false, 0, false, actionType = DebugActionType.Action, allowedGameStates = AllowedGameStates.PlayingOnMap, displayPriority = 100)]
